...
namespace Framelab\Bundle\DocumentBundle\Controller;
...
class DocumentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DocumentBundle:Document')->findAll();
     ...
     * @Method("POST")
     * @Template("DocumentBundle:Document:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DocumentBundle:Document')->find($id);
     ...
     * @Method("PUT")
     * @Template("DocumentBundle:Document:edit.html.twig")
     */
